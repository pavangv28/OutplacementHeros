  ...
  <style type="text/css">
    * 
    ...
    .flexcardNumber:before 
    {
      ...
      z-index: -1;
      background: -moz-linear-gradient(bottom, #95B7A2, #33FF99);
    }
    ...
    .flexcardGreen 
    {
      ...
      box-shadow: 4px 8px 0px #33FF99;
    }
    .flexcardNumberGreen 
    {
      background: #33FF99;
      background: -webkit-linear-gradient(right, #FCFCFC, #33FF99);
      background: -moz-linear-gradient(right, #FCFCFC, #33FF99);
      background: linear-gradient(to left, #FCFCFC, #33FF99);
      box-shadow: 0px 2px 2px #33FF99;
    }
    ...
    .flexcardBlue 
    {
      background: rgba(231, 252, 3,0.2);
      box-shadow: 4px 8px 1px #e7fc03;
    }
    .flexcardNumberBlue 
    {
      background: #FCFCFC;
      background: -webkit-linear-gradient(right, #FCFCFC, #e7fc03);
      background: -moz-linear-gradient(right, #FCFCFC, #e7fc03);
      background: linear-gradient(to left, #FCFCFC, #e7fc03);
      box-shadow: 0px 2px 2px #e7fc03;
    }
    ...
    {
      background: #FCFCFC;
      background: -webkit-linear-gradient(right, #FCFCFC, #F68404);
      background: -moz-linear-gradient(right, #FCFCFC, #F68404);
      background: linear-gradient(to left, #FCFCFC, #F68404);
    ...
    .flexcardPink 
    {
      ...
      box-shadow: 4px 8px 1px #ff1493 ;
    }
    .flexcardNumberPink 
    {
      background: #FCFCFC;
      background: -webkit-linear-gradient(right, #FCFCFC, #FF1493);
      background: -moz-linear-gradient(right, #FCFCFC, #FF1493);
      background: linear-gradient(to left, #FCFCFC, #FF1493);
      box-shadow: 0px 2px 2px #FF1493;
    }
    ...
    @media only screen and (max-width: 767px){.ribbon{ font-size: 25px; }video{display: none;}}
    @media only screen and (max-width: 479px){.ribbon{ font-size: 20px; }video{display: none;}}
    @media only screen and (max-width: 359px){.ribbon{ font-size: 15px; }video{display: none;}}
    /*Team CSS*/
...
<body>
  ...
  <div class="flexbox">
    <div class="flexcard flexcardGreen">
      ...
      <div class="row">
        <a href="{{ route('consultant.register') }}" class="btn btn-lg green">Register</a>
      </div>
    </div>
    <div class="flexcard flexcardOrange">
      <div class="flexcardNumber flexcardNumberOrange"></div>
      <div class="flex flexcardTitle" style="margin-top: 5%;">Volunteers<br></div>
      <div class="flex flexcardTitle" style="margin-left: -1.5%">Extending<br></div>
      ...
      <div class="row">
        <a href="{{ route('volunteer.register') }}" class="btn btn-lg orange">Register</a>
      </div>
    </div>
    ...
    <div class="flexcard flexcardPink">
      <div class="flexcardNumber flexcardNumberPink"></div>
      ...
      <div class="flex flexcardTitle" style="margin-left: -15%">Seeking<br></div>
      <div class="flex flexcardTitle" style="margin-right: -1%">Outplacement</div>
      <div class="flex flexcardTitle" style="margin-left: -14%">Support</div>
      <div class="row">
        <a href="{{ route('semployer.register') }}" class="btn btn-lg pink">Register</a>
      </div>
    </div>
  </div> 
  <!--Video Section-->
  ...
  <video id="player" style="margin-bottom: 10%;margin-left: 18%;margin-top: -5%;" width="800" height="450" poster="{{ asset('HomeImages/3.jpeg') }}" controls>
