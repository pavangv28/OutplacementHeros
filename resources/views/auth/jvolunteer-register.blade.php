<head>
    <title>Mentor(Job Support) Signup</title>
          ...
          <div class="col-md-12 col-lg-6 mb-5">
            ...
            <form method="POST" action="{{ route('jvol.register') }}" class="p-5 bg-white">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-12">
                        <input id="email" class="txt" type="text" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ old('email') }}" required>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-12">
                        <input type="text" class="txt" id="date_dob" class="form-control datepicker @error('dob') is-invalid @enderror" name="dob" value="{{ old('dob') }}" required>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-12">
                        <input id="password" class="txt" type="password" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" name="password" value="{{ old('password') }}" required>
